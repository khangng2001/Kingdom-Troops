...
Shader "Custom/Lordenfel/ThreeWayBlend"
{
	Properties
	{
		...
		_Layer1RooghnessMin("Layer 1 Rooghness Min", Float) = 0.2
		_Layer3RooghnessMin("Layer 3 Rooghness Min", Float) = 0.2
		_Layer2RooghnessMin("Layer 2 Rooghness Min", Float) = 0.2
		_Layer1RooghnessMax("Layer 1 Rooghness Max", Float) = 0.8
		_Layer3RooghnessMax("Layer 3 Rooghness Max", Float) = 0.8
		_Layer2RooghnessMax("Layer 2 Rooghness Max", Float) = 0.8
	...
	SubShader
	{
		...
		uniform float _Layer1RooghnessMin;
		uniform float _Layer1RooghnessMax;
		uniform float _Layer2RooghnessMin;
		uniform float _Layer2RooghnessMax;
		uniform float _Layer3RooghnessMin;
		uniform float _Layer3RooghnessMax;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float temp_output_2_0_g6 = _Layer2EdgeSmoothness;
			float temp_output_5_0_g6 = ( temp_output_2_0_g6 / _Layer2BlendPrecision );
			float temp_output_4_0_g6 = ( 1.0 - i.vertexColor.r );
			float lerpResult7_g6 = lerp( ( 1.0 - temp_output_5_0_g6 ) , temp_output_5_0_g6 , temp_output_4_0_g6);
			...
			float lerpResult11_g6 = lerp( ( temp_output_2_0_g6 + lerpResult7_g6 ) , ( ( 1.0 - temp_output_2_0_g6 ) + lerpResult7_g6 ) , tex2DNode1.a);
			float clampResult12_g6 = clamp( lerpResult11_g6 , 0.0 , 1.0 );
			float lerpResult13_g6 = lerp( 0.0 , clampResult12_g6 , temp_output_4_0_g6);
			float temp_output_40_0 = lerpResult13_g6;
			float3 lerpResult17 = lerp( UnpackNormal( tex2D( _Layer1Normal, uv_Layer1Normal ) ) , UnpackNormal( tex2D( _Layer2Normal, uv_Layer2Normal ) ) , temp_output_40_0);
			float2 uv_Layer3Normal = i.uv_texcoord * _Layer3Normal_ST.xy + _Layer3Normal_ST.zw;
			float temp_output_2_0_g7 = _Layer3EdgeSmoothness;
			float temp_output_5_0_g7 = ( temp_output_2_0_g7 / _Layer3BlendPrecision );
			float temp_output_4_0_g7 = ( 1.0 - i.vertexColor.g );
			float lerpResult7_g7 = lerp( ( 1.0 - temp_output_5_0_g7 ) , temp_output_5_0_g7 , temp_output_4_0_g7);
			...
			float lerpResult18 = lerp( tex2DNode1.a , tex2DNode7.a , temp_output_40_0);
			float lerpResult11_g7 = lerp( ( temp_output_2_0_g7 + lerpResult7_g7 ) , ( ( 1.0 - temp_output_2_0_g7 ) + lerpResult7_g7 ) , lerpResult18);
			float clampResult12_g7 = clamp( lerpResult11_g7 , 0.0 , 1.0 );
			float lerpResult13_g7 = lerp( 0.0 , clampResult12_g7 , temp_output_4_0_g7);
			float temp_output_41_0 = lerpResult13_g7;
			float3 lerpResult26 = lerp( lerpResult17 , UnpackNormal( tex2D( _Layer3Normal, uv_Layer3Normal ) ) , temp_output_41_0);
			o.Normal = lerpResult26;
			float4 lerpResult15 = lerp( tex2DNode1 , tex2DNode7 , temp_output_40_0);
			...
			float4 lerpResult24 = lerp( lerpResult15 , tex2DNode20 , temp_output_41_0);
			o.Albedo = lerpResult24.rgb;
			float3 temp_cast_1 = (_Specular).xxx;
			o.Specular = temp_cast_1;
			float lerpResult4 = lerp( _Layer1RooghnessMin , _Layer1RooghnessMax , tex2DNode1.r);
			float lerpResult9 = lerp( _Layer2RooghnessMin , _Layer2RooghnessMax , tex2DNode7.r);
			float lerpResult16 = lerp( lerpResult4 , lerpResult9 , temp_output_40_0);
			float lerpResult23 = lerp( _Layer3RooghnessMin , _Layer3RooghnessMax , tex2DNode20.r);
			float lerpResult25 = lerp( lerpResult16 , lerpResult23 , temp_output_41_0);
...
/*ASEBEGIN
Version=18100
-1888;349;1824;1312;2291.984;382.2802;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-3313.805,-206.2624;Inherit;False;Property;_Layer1RooghnessMax;Layer 1 Rooghness Max;5;0;Create;True;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-3308.805,-284.2622;Inherit;False;Property;_Layer1RooghnessMin;Layer 1 Rooghness Min;2;0;Create;True;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-3384.709,480.1342;Inherit;False;Property;_Layer2RooghnessMin;Layer 2 Rooghness Min;4;0;Create;True;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-3385.709,570.1342;Inherit;False;Property;_Layer2RooghnessMax;Layer 2 Rooghness Max;7;0;Create;True;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;40;-2894.101,66.26099;Inherit;False;HeightLerp_Lordenfel;-1;;6;f647aa9a482e9f84281f939249978d59;0;4;1;FLOAT;0.5;False;2;FLOAT;50;False;3;FLOAT;5;False;4;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-1696.057,64.2912;Inherit;False;Property;_Layer3RooghnessMax;Layer 3 Rooghness Max;6;0;Create;True;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-1694.057,-25.70866;Inherit;False;Property;_Layer3RooghnessMin;Layer 3 Rooghness Min;3;0;Create;True;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;41;-1864.575,495.9651;Inherit;False;HeightLerp_Lordenfel;-1;;7;f647aa9a482e9f84281f939249978d59;0;4;1;FLOAT;0.5;False;2;FLOAT;50;False;3;FLOAT;5;False;4;FLOAT;0.5;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=AFACD5BDD72A91395D114ECA29BF419A25E1CF92